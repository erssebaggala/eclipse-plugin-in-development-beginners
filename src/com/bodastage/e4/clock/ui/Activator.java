...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "com.bodastage.e4.clock.ui"; //$NON-NLS-1$
	...
	public void start(BundleContext context) throws Exception {
		...
		//However, getDefault() returned above exception. So I went with getCurrent()
			...
			if( tray != null && image != null ){
				...
				trayItem.addSelectionListener( new SelectionAdapter(){
					public void widgetSelected(SelectionEvent e){
						Shell shell = new Shell(trayItem.getDisplay(), SWT.NO_TRIM | SWT.ON_TOP );
